...
import skincareRoutes from './routes/skincare.routes';
...
const createApp = (): Application => {
   ...
   * - /api/v1/skincare/* - Skincare recommendations
  ...
  app.use(`${apiPrefix}/skincare`, skincareRoutes);
    ...
    const apiInfo = {
      ...
      endpoints: {
        ...
        analysis: {
          ...
          generateHeatmap: 'POST /api/v1/analysis/heatmap',
  ...
  try {
    ...
    app.listen(PORT, () => {
      ...
      logger.info('📋 Available endpoints:', {
        ...
        skincare: `/api/${config.apiVersion}/skincare/*`,
        chatbot: `/api/${config.apiVersion}/chatbot/*`,
        report: `/api/${config.apiVersion}/report/*`,
      });
